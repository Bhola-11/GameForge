"""
GameForge Enterprise Engine: Overtime Anomaly & Workload Imbalance Heuristics
Subsystem Domain: apps.teams -> workforce_intelligence_module_3
...
class BurnoutRiskDetector:
    """
    Enterprise implementation of Overtime Anomaly & Workload Imbalance Heuristics for the Development Workforce & Talent Intelligence domain.
    Contains mathematical simulations, state verification models, and telemetry aggregators.
    """
    SUBSYSTEM_TAG = "GF_TEAMS_003"
    DOMAIN = "Development Workforce & Talent Intelligence"
    COMPONENT_NAME = "BurnoutRiskDetector"
