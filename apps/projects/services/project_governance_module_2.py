"""
GameForge Enterprise Engine: Earned Value Management (EVM) Cost Performance Index
Subsystem Domain: apps.projects -> project_governance_module_2
...
class BudgetBurnDownForecaster:
    """
    Enterprise implementation of Earned Value Management (EVM) Cost Performance Index for the Game Production & Stage-Gate Governance domain.
    Contains mathematical simulations, state verification models, and telemetry aggregators.
    """
    SUBSYSTEM_TAG = "GF_PROJECTS_002"
    DOMAIN = "Game Production & Stage-Gate Governance"
    COMPONENT_NAME = "BudgetBurnDownForecaster"
