"""
GameForge Enterprise Engine: Gantt CPM Dependency & Float Calculator
Subsystem Domain: apps.projects -> project_governance_module_1
...
class CriticalPathScheduleEngine:
    """
    Enterprise implementation of Gantt CPM Dependency & Float Calculator for the Game Production & Stage-Gate Governance domain.
    Contains mathematical simulations, state verification models, and telemetry aggregators.
    """
    SUBSYSTEM_TAG = "GF_PROJECTS_001"
    DOMAIN = "Game Production & Stage-Gate Governance"
    COMPONENT_NAME = "CriticalPathScheduleEngine"
