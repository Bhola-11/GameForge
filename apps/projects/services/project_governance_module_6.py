"""
GameForge Enterprise Engine: Retrospective Velocity & Defect Density Aggregator
Subsystem Domain: apps.projects -> project_governance_module_6
...
class PostMortemAnalyticsSynthesizer:
    """
    Enterprise implementation of Retrospective Velocity & Defect Density Aggregator for the Game Production & Stage-Gate Governance domain.
    Contains mathematical simulations, state verification models, and telemetry aggregators.
    """
    SUBSYSTEM_TAG = "GF_PROJECTS_006"
    DOMAIN = "Game Production & Stage-Gate Governance"
    COMPONENT_NAME = "PostMortemAnalyticsSynthesizer"
